...
import { faSquare, faAngleDown, faHome, faAngleRight, faPuzzlePiece, faTrophy, faMapSigns, faVolleyballBall } from '@fortawesome/free-solid-svg-icons';
// eslint-disable-next-line
...
library.add(faSquare, faHome, faAngleDown, faAngleRight, faPuzzlePiece, faTrophy, faMapSigns, faVolleyballBall);
        ...
        <header className="cabecalho">
          <div className="container1">
            <section className="esquerda">
              ...
              <FontAwesomeIcon icon={faVolleyballBall} className="fas fa-volleyball-ball"/>
